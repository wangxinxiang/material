...
public class OfficeDBHelper extends SQLiteOpenHelper {
    ...
    private static OfficeDBHelper instance;//这里主要解决死锁问题,是static就能解决死锁问题
     ...
     * @return  instance
     */
    public static OfficeDBHelper getHelper(Context context){
        if(instance==null)
            instance=new OfficeDBHelper(context);
        return instance;
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE table IF NOT EXISTS officeuser"
                + " (_id INTEGER PRIMARY KEY AUTOINCREMENT,officename TEXT,username TEXT,headimage TEXT, job TEXT)");
    }
    //第一版数据库，不用更新
    @Override
