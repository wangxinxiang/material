...
//import com.jhlc.zxl.bean.PostBackDataBean;
//import com.jhlc.zxl.bean.UserBean;
//import com.jhlc.zxl.db.NoteBookDB;
//import com.jhlc.zxl.db.ProgressReportDB;
//import com.jhlc.zxl.db.SetNewMsgDB;
//import com.jhlc.zxl.db.UserListDB;
//import com.jhlc.zxl.service.LoaderBusiness;
//import com.jhlc.zxl.utils.*;
//import com.jhlc.zxl.view.RoundImageView;
...
//
//    private Button ibtn_changeHeadImg, ibtn_changeName, ibtn_logout;
...
//        ibtn_changeName = (Button) findViewById(R.id.ibtn_changeName);
...
//
//
//        ibtn_changeName.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//                inputTitleDialog();
...
//            }
//        } else {
//            if (StringUtils.isNotBlank(PreferenceUtils.getWebHeadImageUrl())) {
//                LoaderBusiness.loadImage(MYURL.img_HEAD + PreferenceUtils.getWebHeadImageUrl(), img_head);
//            }
//        }
//    }
//
...
//                    ibtn_changeName.setEnabled(false);
...
//                    ibtn_changeName.setEnabled(true);
...
//                zxlApplication.showTextToast("用户名已经存在，请重新输入");
//
...
//                preferenceUtils.setUserName(inputName);
//                tv_user_name.setText(preferenceUtils.getUserName());
//            }
//        }
//    }
...
//        inputServer.setText(preferenceUtils.getUserName().toString());
