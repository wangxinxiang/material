...
public class ChatMsgViewAdapterMapTemp extends BaseAdapter {
    ...
    public ChatMsgViewAdapterMapTemp(Context context, LinkedList<WorkDetailList> workDetailLists, int UpOrDown, String headimage) {
        ctx = context;
