...
public class FootPullToRefreshView extends LinearLayout {
	private static final String TAG = "FootPullToRefreshView";
	// refresh states
...
//	private String mLastUpdateTime;
	...
	public FootPullToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public FootPullToRefreshView(Context context) {
		super(context);
		init();
	}
...
//	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(FootPullToRefreshView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(FootPullToRefreshView view);
	}
}
